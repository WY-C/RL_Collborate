...
class GridEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        goal = random.sample(range(1, self.grid_size*self.grid_size - 1), 2)
    ...
    def step(self, action):
        ...
        if new_distance_1 < old_distance_1:
            ...
            self.reward[0] = -0.1 * (self.timestep // 4) 
        ...
        if new_distance_2 < old_distance_2:
            ...
            self.reward[1] = -0.1 * (self.timestep // 4)

        # 서로 다른 goal
        # 둘다 안먹었는데 같은 goal이 골라진 경우.
        # if Agent1_Goal == Agent2_Goal and (gx1 != -99 and gx2 != -99):
        #     if(self.reward[0] > 0) :
        #         self.reward[0] /= 2
        #     if(self.reward[1] > 0) :
        #         self.reward[1] /= 2
        # 서로 다른 goal을 선택하는 전략 + ver.
        # if Agent1_Goal != Agent2_Goal:
        #     self.reward[0] += 0.1
        #     self.reward[1] += 0.1
        ...
        if (gx1 == -99 and gx2 == -99 and gy1 == -99 and gy2 == -99) or self.timestep >= self.max_timestep:
            terminated = True
        else:
            terminated = False
