...
try:
    Agent1.load_model("model/28000_Agent1_DQN_PER.pth")
    Agent2.load_model("model/28000_Agent1_DQN_PER.pth")
...
for i in range(100000000):
    ...
    while not terminated:
        ...
        Agent1.replay_buffer.add(state, action[0], reward[0], next_state, terminated, 10.0) 
        Agent2.replay_buffer.add(state, action[1], reward[1], next_state, terminated, 10.0)
    ...
    if (i + 1) % 1000 == 0:
        Agent1.save_model(f"model/{i+1}_Agent1_DQN_PER.pth")
        Agent2.save_model(f"model/{i+1}_Agent2_DQN_PER.pth")
